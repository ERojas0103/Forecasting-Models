...
print("Iniciando la generación del gráfico de dispersión para Irradiación Solar...")

# --- Configuración ---
file_path = 'pv_data.xlsx'
output_filename = 'irradiacion_scatterplot_diario_anual.svg'
font_size = 18
...
# Elimina filas donde la irradiación sea nula para limpiar el gráfico
df.dropna(subset=['Irradiation_Wm2'], inplace=True)
...
# Eje Y: Irradiación solar
# Color: Morado
ax.scatter(df['Timestamp'], df['Irradiation_Wm2'], s=5, alpha=0.5, color='purple')

# --- 3. Personalización del Gráfico ---
ax.set_xlabel("Mes", fontsize=font_size)
ax.set_ylabel("Irradiación (W/m²)", fontsize=font_size)
