...
gbr_model.fit(X_train_scaled, y_train) # Entrena
y_pred = gbr_model.predict(X_test_scaled) # Predice
...
print("--- Métricas de Rendimiento del Modelo (Gradient Boosting) ---")
...
ax.set_xlabel('Fecha y Hora', fontsize=18)
ax.set_ylabel('Producción Fotovoltaica (Wh)', fontsize=18)
